...
public class Loader : MonoBehaviour
{
    ...
    public Text _uiJumpBonusAfterGame;
    public Text _uiShieldBonusAfterGame;
    public Text _uiExtraPointsAfterGame;
    public Text _uiTimeBonusAfterGame;
    ...
    void Awake()
    {
        ...
        if (GameManager.instance == null)
        {
            ...
            GM.GetComponent<GameManager>().uiShieldBonusAfterGame = _uiShieldBonusAfterGame;
            GM.GetComponent<GameManager>().uiJumpBonusAfterGame = _uiJumpBonusAfterGame;
            GM.GetComponent<GameManager>().uiExtraPointsAfterGame = _uiExtraPointsAfterGame;
            GM.GetComponent<GameManager>().uiTimeBonusAfterGame = _uiTimeBonusAfterGame;
